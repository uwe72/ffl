...
public class UnsubscribeController {
    ...
    private String buildPage(String title, String innerContent) {
        return "<!DOCTYPE html><html lang=\"de\"><head>"
            ...
            + ".footer-border{border-top:1px solid #d6d3d1;padding-top:16px;display:flex;justify-content:space-between;}"
            + ".footer-border form{display:flex;justify-content:space-between;gap:12px;}"
