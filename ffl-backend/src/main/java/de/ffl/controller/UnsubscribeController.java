...
public class UnsubscribeController {
    ...
    private String buildConfirmationPage(String email, Long id, String token) {
        return "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">"
            ...
            + "<body style=\"background:#e7e5e4;font-family:Inter,-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,Arial,sans-serif;padding:40px 20px;margin:0;color:#1c1917;\">"
            + "<div style=\"max-width:500px;margin:0 auto;background:#ffffff;border:1px solid #d6d3d1;border-radius:6px;padding:40px;\">"
            + "<p style=\"margin:0 0 6px 0;color:#78716c;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;\">FFL &middot; Fantasy Football League</p>"
            + "<h1 style=\"color:#1c1917;font-size:22px;margin:0 0 8px 0;\">Abmeldung vom Verteiler</h1>"
            + "<p style=\"color:#57534e;font-size:14px;margin:0 0 24px 0;\">Möchten Sie sich wirklich aus dem FFL-Mailverteiler austragen?</p>"
            + "<p style=\"color:#1c1917;font-size:14px;margin:0 0 8px 0;\">E-Mail: <strong>" + escapeHtml(email) + "</strong></p>"
            + "<p style=\"color:#78716c;font-size:13px;margin:0 0 24px 0;\">Sie erhalten dann keine weiteren Mails von der FFL.</p>"
            + "<form method=\"POST\" action=\"/api/public/unsubscribe?id=" + id + "&token=" + escapeHtml(token) + "\">"
            + "<button type=\"submit\" style=\"background:#dc2626;color:#ffffff;border:none;border-radius:6px;padding:12px 24px;font-size:15px;font-weight:700;cursor:pointer;\">Ja, austragen</button>"
            + "</form>"
            + "</div></body></html>";
    }
    ...
    private String buildSuccessPage(String email) {
        return "<!DOCTYPE html><html><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width,initial-scale=1\">"
            ...
            + "<div style=\"max-width:500px;margin:0 auto;background:#ffffff;border:1px solid #d6d3d1;border-radius:6px;padding:40px;\">"
            + "<p style=\"margin:0 0 6px 0;color:#78716c;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;\">FFL &middot; Fantasy Football League</p>"
            + "<h1 style=\"color:#1c1917;font-size:22px;margin:0 0 24px 0;\">Abmeldung vom Verteiler</h1>"
            + "<div style=\"background:#f0fdf4;border:1px solid #bbf7d0;border-radius:6px;padding:16px;\">"
            + "<p style=\"color:#166534;font-size:16px;font-weight:700;margin:0 0 8px 0;\">&check; Erfolgreich ausgetragen</p>"
