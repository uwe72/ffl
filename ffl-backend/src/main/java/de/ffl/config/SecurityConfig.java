...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/login", "/players", "/teams", "/seasons", "/managers", "/users", "/games", "/feedback", "/documents", "/umfrage", "/umfragen").permitAll()
                .requestMatchers("/players/**", "/teams/**", "/seasons/**", "/managers/**", "/users/**", "/games/**", "/documents/**", "/umfrage/**", "/umfragen/**").permitAll()
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://localhost:5173", "http://localhost:5174", "https://ffl.ipv64.de"));
    ...
    public Jackson2ObjectMapperBuilderCustomizer jsonCustomizer() {
        return builder -> {
            ...
            builder.mixIn(org.hibernate.proxy.HibernateProxy.class, HibernateProxyMixin.class);
        };
    }
