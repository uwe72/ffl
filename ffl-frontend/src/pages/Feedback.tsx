...
export default function Feedback() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0f1419] py-12 px-4 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('/background.png')" }}>
